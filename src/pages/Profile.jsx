      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 mb-4">
          ...
          <div className="flex items-center gap-5">
            <div className="w-20 h-20 rounded-xl border-2 border-dashed border-slate-700 overflow-hidden flex items-center justify-center bg-slate-800">
              {logoPreview
            ...
            <div className="flex flex-col gap-2">
              <label className="cursor-pointer bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-300 px-4 py-2 rounded-lg text-xs font-semibold transition">
